...
type GlobalExternalAuthorization struct {
	...
	//
	// +optional
	ServiceAPIType contour_api_v1.AuthorizationServiceAPIType `json:"serviceAPIType,omitempty"`
	// HttpAuthorizationServerSettings defines configurations for interacting with an external HTTP authorization server.
	//
	// +optional
	HTTPServerSettings *contour_api_v1.HTTPAuthorizationServerSettings `json:"httpSettings,omitempty"`
